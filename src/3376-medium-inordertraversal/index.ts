...
> = T[Side] extends TreeNode ? InorderTraversal<T[Side]> : [];
type Left<T extends TreeNode> = Side<T, "left">;
type Right<T extends TreeNode> = Side<T, "right">;
type Value<T extends TreeNode> = T["val"];

type InorderTraversal<T extends TreeNode | null> = T extends TreeNode
  ? [...Left<T>, Value<T>, ...Right<T>]
  : [];
